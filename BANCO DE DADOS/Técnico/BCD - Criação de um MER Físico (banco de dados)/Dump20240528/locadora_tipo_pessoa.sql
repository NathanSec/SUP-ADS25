...
CREATE TABLE `tipo_pessoa` (
  ...
  `tipo` enum('Cliente','Funcionário') NOT NULL DEFAULT 'Cliente',
  PRIMARY KEY (`id_tipo_pessoa`),
  KEY `fk_tipo_pessoa_pessoa_idx` (`id_pessoa`),
  CONSTRAINT `fk_tipo_pessoa` FOREIGN KEY (`id_pessoa`) REFERENCES `pessoa` (`id_pessoa`)
...
INSERT INTO `tipo_pessoa` VALUES (1,1,'Cliente'),(2,2,'Funcionário'),(3,3,'Cliente'),(4,4,'Cliente'),(5,5,'Funcionário');
